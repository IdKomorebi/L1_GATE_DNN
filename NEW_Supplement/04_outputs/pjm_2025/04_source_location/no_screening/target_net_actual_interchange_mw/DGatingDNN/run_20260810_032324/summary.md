...
运行时间 20260810_032324　方法 **DGatingDNN**
...
| 排名 | 字段 | 业务含义 | 门控值 |
|---|---|---|---|
| 1 | `net_sched_interchange_mw` | 净计划交换 | 0.0577 |
...
| 字段 | 业务含义 | 门控值 |
|---|---|---|
| `net_inadv_interchange_mw` | 净非计划交换 | 0.0046 |
...
|---|---|---|---|
| DNN | 1.0000 | 第 200 轮 | 58 |
| L1GateDNN | 1.0000 | 第 139 轮 | 1 |
| DGatingDNN | 1.0000 | 第 160 轮 | 1 |
