...
运行时间 20260810_045934　方法 **DGatingDNN**
...
| 排名 | 字段 | 业务含义 | 门控值 |
|---|---|---|---|
| 1 | `da_as_nsr_mw_primary_reserve` | 非同步备用 | 0.0486 |
| 2 | `da_as_as_mw_synchronized_reserve` | 日前同步备用实际量 | 0.0391 |
...
|---|---|---|---|
| DNN | 1.0000 | 第 176 轮 | 58 |
| L1GateDNN | 1.0000 | 第 182 轮 | 1 |
| DGatingDNN | 1.0000 | 第 185 轮 | 2 |
