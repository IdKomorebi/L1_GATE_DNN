...
运行时间 20260810_035259　方法 **DGatingDNN**
...
| 排名 | 字段 | 业务含义 | 门控值 |
|---|---|---|---|
| 1 | `metered_load_mw` | 计量负荷 | 0.0558 |
| 2 | `net_sched_interchange_mw` | 净计划交换 | 0.0132 |
...
| L1GateDNN | 0.9999 | 第 104 轮 | 1 |
| DGatingDNN | 0.9999 | 第 101 轮 | 2 |
