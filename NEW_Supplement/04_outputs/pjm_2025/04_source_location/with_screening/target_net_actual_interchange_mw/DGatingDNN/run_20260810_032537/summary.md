...
运行时间 20260810_032537　方法 **DGatingDNN**
...
- 从 39 个候选字段里选出 **1 个**推断源（占 2.6%）
- 只用这 1 个字段重新训练普通 DNN，测试 R² = **0.9987**
- 作为对照，用全部 39 个字段的普通 DNN 测试 R² = 0.9987
- 没被选中的 38 个字段单独训练，测试 R² = 0.9239
...
| 排名 | 字段 | 业务含义 | 门控值 |
|---|---|---|---|
| 1 | `net_sched_interchange_mw` | 净计划交换 | 0.0883 |
...
|---|---|---|---|
| DNN | 0.9987 | 第 127 轮 | 39 |
| L1GateDNN | 0.9988 | 第 119 轮 | 1 |
| DGatingDNN | 0.9988 | 第 10 轮 | 1 |
