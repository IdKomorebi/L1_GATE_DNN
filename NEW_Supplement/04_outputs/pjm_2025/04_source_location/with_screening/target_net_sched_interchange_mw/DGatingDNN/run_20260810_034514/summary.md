...
运行时间 20260810_034514　方法 **DGatingDNN**
...
- 从 38 个候选字段里选出 **1 个**推断源（占 2.6%）
- 只用这 1 个字段重新训练普通 DNN，测试 R² = **0.9987**
- 作为对照，用全部 38 个字段的普通 DNN 测试 R² = 0.9987
- 没被选中的 37 个字段单独训练，测试 R² = 0.9215
...
| 排名 | 字段 | 业务含义 | 门控值 |
|---|---|---|---|
| 1 | `net_actual_interchange_mw` | 净实际交换 | 0.0836 |
...
|---|---|---|---|
| DNN | 0.9987 | 第 120 轮 | 38 |
| L1GateDNN | 0.9988 | 第 170 轮 | 1 |
| DGatingDNN | 0.9988 | 第 13 轮 | 1 |
