...
| STG | 随机门控，高斯松弛逼近 L0（ICML 2020） | **0.8408** |

> 同预算下最好的是 **Lasso**（R² = 0.8878）。
...
|---|---|---|---|---|---|---|---|
| Lasso | 0.6200 | 0.6896 | 0.8535 | 0.8878 | 0.8727 | 0.8716 | 0.8724 |
...
| STG | 0.6200 | 0.7111 | 0.8319 | 0.8408 | 0.8502 | 0.8769 | 0.8765 |
